...
CREATE TABLE TUTOR(
    ...
    SUB_NAME VARCHAR2(100) CONSTRAINT TUTOR_SUB_NAME_FK REFERENCES SUBJECT(SUB_NAME),
...
INSERT INTO TUTOR VALUES (2, 'PIC1.jpg', '30만원', 'N', '서울 광진구', '즐거운 수학시간', '월, 목', '14:00,16:00', '기출문제 반복 풀이', '한국대학교 재학중', '120', '8', '토익');
INSERT INTO TUTOR VALUES (4, 'PIC2.jpg',  '60만원', 'Y', '충남 공주시', '토익만점',  '월, 화', '15:00,17:00', '문제풀이를 반복적으로 하며 매주 단어 시험봄', '고려대학교 대학원 졸업', '120', '8', '토익');
INSERT INTO TUTOR VALUES (6, 'PIC3.jpg', '35만원', 'N', '서울시 관악구', '훈민정음', '화, 목', '16:00, 18:00', '꼼꼼하게 수업하며 숙제안하면 나머지 수업 있음', '서울대학교 재학중', '120', '8', '토익');
INSERT INTO TUTOR VALUES (8, 'PIC4.jpg', '25만원', 'Y', '대전 유성구', '재밌는 역사', '화,금', '18:00, 20:00', '역사에 담긴 얘기를 많이 해줌', '서강대학교 졸업', '120', '8', '토익');
INSERT INTO TUTOR VALUES (10, 'PIC5.jpg', '45만원', 'Y', '서울 용산구', 'teacher 노', '수, 일', '16:30, 18:30', '천천히 이해할 수 있을 때까지 자세히 설명함', '동국대학교 졸업', '120', '8', '토익');
INSERT INTO TUTOR VALUES (12, 'PIC6.jpg', '50만원', 'N', '서울 서대문구', '과탐 길동쌤', '목,일', '17:00, 19:30', '기출문제를 분석하여 새로운 문제를 만들어보며 오답노트 활용', '연세대학교 재학중', '120', '8', '토익');
INSERT INTO TUTOR VALUES (14, 'PIC7.jpg', '30만원', 'Y', '인천 연수구', '길동이의 경제교실', '수, 일', '17:30, 19:30', '모의고사 기출문제 반복 풀이', '인천대학교 대학원 재학중', '120', '8', '토익');
INSERT INTO TUTOR VALUES (16, 'PIC8.jpg', '35만원', 'Y', '서울 노원구', '니하오중국어',  '월,금', '17:00, 19:00', '중국어로 수업', '한국외국어대학교 재학중', '120', '8', '토익');
